...
generateButton.addEventListener('click',
    function() {
        ...
        // Genero il posto dell'utente
        const userSeatNumber = Math.floor(Math.random() * 16) + 1;
        const seatChar = "ABCD";
        const userSeatLetter = seatChar[ Math.floor( Math.random() * seatChar.length ) ];
        const userSeat = userSeatNumber + userSeatLetter;
        ...
        document.getElementById("user-seat").innerHTML = userSeat;
